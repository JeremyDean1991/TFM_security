...
cmd_rsync_install_path = 'rpm -q --filesbypkg rsync'
cmd_install_rsync = "yum install -y rsync"
cmd_check_rsync_running = "ps ax | grep rsync"
open_rsync_config_file = 'cat /etc/rsyncd.conf' 
open_rsync_config_file_1 = 'nil /etc/rsyncd.conf' #file with line numbers 
  
cmd_check_rsync_daemon = 'systemctl | grep daemon'
