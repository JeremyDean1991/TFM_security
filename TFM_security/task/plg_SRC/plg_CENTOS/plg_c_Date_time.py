...
def get_date_time (option):

   match option: 
   
      case "1":
         print ("get date time 1")
         
         get_date_time_1 = "date $ISO_8601"       
         return get_date_time_1
...
def test ():  
   ...
   _stdin_1, _stdout_1,_stderr_1 = client1.exec_command(get_date_time(option="1"))
