...
#print(get_url_status_code_1 (url='https://w3schools.com'))




# with random proxy
def get_url_status_code_2 (url):
...
#print(get_url_status_code_2 (url='https://w3schools.com'))
