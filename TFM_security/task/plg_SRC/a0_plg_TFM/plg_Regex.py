...
#print(remove_numbers_from_text_main (text_main = '118	Wendell_Wallach'))
...
#print (remove_all_before_text (before_text='/0', text_main ='123 /0_hello_world_/2_john its me'))




def remove_all_before_text_2 (before_text, text_main):

   new_text_main = re.sub(r'^.*?' + before_text, before_text, text_main).strip()
   
   return new_text_main 

#print (remove_all_before_text_2 (before_text='/0', text_main ='123 /0_hello_world_/2_john its me'))
