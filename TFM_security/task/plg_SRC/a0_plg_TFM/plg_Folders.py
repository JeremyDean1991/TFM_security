...
def get_folder_item_by_index (folder_path, start_index, end_index):

   LIST_folder = get_ALL_in_folder (folder_path)
   
   LIST_selected_item = LIST_folder[start_index:end_index]
...
# item could be a subfolder or a file     
def get_folder_item_by_name (folder_path, my_item_name):

   LIST_folder = get_ALL_in_folder (folder_path)
   
   LIST_selected_item  = []
   
   for item_name in LIST_folder:
   
      if my_item_name not in item_name:
      
         print (item_name + ' NOT in ' + item)
